...
def shangpinxinxi_page(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        if  __isAdmin__ == "是":
            ...
            if tablename!="users" and "userid" in shangpinxinxi.getallcolumn(shangpinxinxi,shangpinxinxi):
                req_dict["userid"] = request.session.get("params").get("id")
...
def shangpinxinxi_update(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        if req_dict.get("mima") and req_dict.get("password"):
            if "mima" not  in shangpinxinxi.getallcolumn(shangpinxinxi,shangpinxinxi) :
                del req_dict["mima"]
            if  "password" not  in shangpinxinxi.getallcolumn(shangpinxinxi,shangpinxinxi) :
